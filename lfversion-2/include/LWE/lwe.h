...
void knuth_yao2(uint16_t a[LWE_M]);
...
void r2_gen2(uint16_t r2[LWE_M]);
void key_gen2(uint16_t a[LWE_M], uint16_t p[LWE_M], uint16_t r2[LWE_M]);
...
void RLWE_enc2(uint16_t a[LWE_M], uint16_t c1[LWE_M], uint16_t c2[LWE_M], uint16_t m[LWE_M], uint16_t p[LWE_M]);
...
void get_rand_input(uint32_t i, uint32_t large1[LWE_M], uint32_t large2[LWE_M]);
uint32_t get_rand();
